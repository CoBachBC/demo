...
1. Abre Thunderbird. Si no lo tienes instalado [descárgalo e instálalo para continuar](https://www.thunderbird.net/es-ES/).

1. Si es la primera vez que usas Thunderbird, verás una pantalla similar a esta. Elige **Cancelar**.

![](/assets/images/workspace-takeout-mbox-01.png){: .img-tutorial-h}

1. Verifica que estés en la pestaña de inicio haciendo clic en la esquina superior izquierda.

![](/assets/images/workspace-takeout-mbox-02.png){: .img-tutorial-h}

1. Haz clic en el botón **Canales**

![](/assets/images/workspace-takeout-mbox-03.png){: .img-tutorial-h}

1. Ingresa un nombre para identificarlo
...
1. Haz clic en el botón de menú en la esquina superior derecha, y luego haz clic en **Configuración de cuenta**.

![](/assets/images/workspace-takeout-mbox-06.png){: .img-tutorial-h}

1. Selecciona **Carpetas locales** y haz clic en el botón **Examinar**. 

![](/assets/images/workspace-takeout-mbox-07.png){: .img-tutorial-h}

1. Selecciona la carpeta que contiene **tu archivo .mbox** y haz clic en **Seleccionar carpeta**. 

![](/assets/images/workspace-takeout-mbox-08.png){: .img-tutorial-h}

1. Thunderbird te notificará que necesita reiniciar, haz clic en Reiniciar

![](/assets/images/workspace-takeout-mbox-09.png){: .img-tutorial-h}

1. Al reiniciar Thunderbird te mostrará la pestaña en que estabas trabajando. Puedes cerrar la pestaña de configuración y la noticias para que te quedes solo con la que te muestra tus correos.

![](/assets/images/workspace-takeout-mbox-10.png){: .img-tutorial-h}

1. En la parte izquierda, encontrarás una sección de **Carpetas locales**, y en ella encontrarás el nombre de tu archivo .mbox (que contiene el respaldo de tus correos). Haz clic en él (puede tardar un momento en cargarlo, dependiendo de la cantidad de información).

![](/assets/images/workspace-takeout-mbox-11.png){: .img-tutorial-h}

1. En la sección principal verás la lista de correos, al seleccionar uno verás su contenido en el panel inferior.

![](/assets/images/workspace-takeout-mbox-12.png){: .img-tutorial-h}

1. Para filtrar tus correos, ingresa el término que buscas en la casilla de filtro en la parte derecha de la barra de acciones en el panel principal.
